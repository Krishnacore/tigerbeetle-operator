...
import (
	...
	"github.com/krishnacore/tigerbeetle-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "454cef43.tigerbeetle.com",
	...
	if err := (&controller.TigerBeetleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TigerBeetle")
		os.Exit(1)
	}
